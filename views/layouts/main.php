    ...
    <!-- Header -->
            ...
            <section id="team" class="bg-light-gray">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="section-heading">Nossa equipe incrível</h2>
                            <h3 class="section-subheading text-muted">Os líderes da Empresa</h3>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-4">
                            <div class="team-member">
                                ...
                                <h4>Itamar Lourenço</h4>
                                <p class="text-muted">Lider Mobile</p>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="team-member">
                                ...
                                <h4>Jefferson Leite</h4>
                                <p class="text-muted">Lider de Desenvolvimento e CEO</p>
                                <ul class="list-inline social-buttons">
                                    <li><a href="https://twitter.com/jeffersonpl"><i class="fa fa-twitter"></i></a>
                                    </li>
                                    <li><a href="https://www.facebook.com/jeffersonpl"><i class="fa fa-facebook"></i></a>
                                    </li>
                                    <li><a href="https://www.linkedin.com/profile/view?id=178697839&trk=nav_responsive_tab_profile"><i class="fa fa-linkedin"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
